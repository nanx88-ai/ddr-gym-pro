...
export const card = "rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900";
...
export const pageBg = "min-h-screen bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100";
export const headerBg = "border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900";
export const tableHeadBg = "border-b border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900/60";

export const errorBox =
  "mb-4 rounded-md border border-red-300 bg-red-50 px-3 py-2 text-sm text-red-700 dark:border-red-800 dark:bg-red-950/50 dark:text-red-300";
export const successBox =
  "mb-4 rounded-md border border-green-300 bg-green-50 px-3 py-2 text-sm text-green-700 dark:border-green-800 dark:bg-green-950/50 dark:text-green-300";
