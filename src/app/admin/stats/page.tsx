  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className={pageSubtitle}>
        Basate su {stats.totalBookings} prenotazion{stats.totalBookings === 1 ? "e" : "i"} confermate o in attesa.
      </p>

      <div className="grid gap-4 sm:grid-cols-2">
        <section className={`${card} p-4`}>
          <h2 className="mb-3 text-sm font-semibold text-neutral-900 dark:text-white">Giorni piu' attivi</h2>
          <div className="space-y-2">
            {stats.activeDays.map((d) => (
              <div key={d.dayOfWeek} className="flex items-center gap-3">
                <span className="w-24 shrink-0 text-sm text-neutral-600 dark:text-neutral-300">{d.label}</span>
        ...
        <section className={`${card} p-4`}>
          <h2 className="mb-3 text-sm font-semibold text-neutral-900 dark:text-white">Clienti con piu' prenotazioni</h2>
          <div className="space-y-2">
